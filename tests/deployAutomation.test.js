...
describe('Automated Deploy-Registry System', () => {
    ...
    describe('Registry Updates', () => {
        ...
        beforeEach(() => {
            ...
            originalRegistry = JSON.parse(fs.readFileSync(path.resolve(process.cwd(), 'config/deploy-registry.json'), 'utf-8'));
        });
        afterEach(() => {
            // Restore original registry
            fs.writeFileSync(path.resolve(process.cwd(), 'config/deploy-registry.json'), JSON.stringify(originalRegistry, null, 2) + '\n');
        });
...
//# sourceMappingURL=deployAutomation.test.js.map