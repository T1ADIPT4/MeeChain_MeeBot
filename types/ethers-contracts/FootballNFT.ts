...
export declare namespace FootballNFT {
      
    export type PlayerStruct = {name: string, position: string, rating: BigNumberish, nationality: string, mintedAt: BigNumberish, isLegendary: boolean}

    export type PlayerStructOutput = [name: string, position: string, rating: bigint, nationality: string, mintedAt: bigint, isLegendary: boolean] & {name: string, position: string, rating: bigint, nationality: string, mintedAt: bigint, isLegendary: boolean }
  
    }

  export interface FootballNFTInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "authorizeMinter" | "authorizedMinters" | "balanceOf" | "getApproved" | "getPlayer" | "getUserPlayers" | "isApprovedForAll" | "isAuthorizedMinter" | "mintPlayer" | "name" | "nextTokenId" | "owner" | "ownerOf" | "playerExists" | "players" | "renounceOwnership" | "revokeMinter" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "setBaseURI" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom" | "transferOwnership"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "MinterAuthorized" | "MinterRevoked" | "OwnershipTransferred" | "PlayerMinted" | "Transfer"): EventFragment;
...
encodeFunctionData(functionFragment: 'getPlayer', values: [BigNumberish]): string;
encodeFunctionData(functionFragment: 'getUserPlayers', values: [AddressLike]): string;
encodeFunctionData(functionFragment: 'isApprovedForAll', values: [AddressLike, AddressLike]): string;
encodeFunctionData(functionFragment: 'isAuthorizedMinter', values: [AddressLike]): string;
encodeFunctionData(functionFragment: 'mintPlayer', values: [AddressLike, string, string, BigNumberish, string, boolean, string]): string;
encodeFunctionData(functionFragment: 'name', values?: undefined): string;
encodeFunctionData(functionFragment: 'nextTokenId', values?: undefined): string;
encodeFunctionData(functionFragment: 'owner', values?: undefined): string;
encodeFunctionData(functionFragment: 'ownerOf', values: [BigNumberish]): string;
encodeFunctionData(functionFragment: 'playerExists', values: [string]): string;
...
decodeFunctionResult(functionFragment: 'getUserPlayers', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'playerExists', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
    ...
    export namespace PlayerMintedEvent {
      export type InputTuple = [to: AddressLike, tokenId: BigNumberish, name: string, rating: BigNumberish];
      export type OutputTuple = [to: string, tokenId: bigint, name: string, rating: bigint];
      export interface OutputObject {to: string, tokenId: bigint, name: string, rating: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  export interface FootballNFT extends BaseContract {
    
    connect(runner?: ContractRunner | null): FootballNFT;
    waitForDeployment(): Promise<this>;

    interface: FootballNFTInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getPlayer: TypedContractMethod<
      [tokenId: BigNumberish, ],
      [FootballNFT.PlayerStructOutput],
      'view'
    >
    

    
    getUserPlayers: TypedContractMethod<
      [user: AddressLike, ],
      [bigint[]],
      'view'
    >
    ...
    mintPlayer: TypedContractMethod<
      [to: AddressLike, name: string, position: string, rating: BigNumberish, nationality: string, isLegendary: boolean, tokenURI: string, ],
      [bigint],
      'nonpayable'
    >
    ...
    playerExists: TypedContractMethod<
      [arg0: string, ],
      [boolean],
      'view'
    >
    ...
    players: TypedContractMethod<
      [arg0: BigNumberish, ],
      [[string, string, bigint, string, bigint, boolean] & {name: string, position: string, rating: bigint, nationality: string, mintedAt: bigint, isLegendary: boolean }],
      'view'
    >
...
getFunction(nameOrSignature: 'getApproved'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getPlayer'): TypedContractMethod<
      [tokenId: BigNumberish, ],
      [FootballNFT.PlayerStructOutput],
      'view'
    >;
getFunction(nameOrSignature: 'getUserPlayers'): TypedContractMethod<
      [user: AddressLike, ],
      [bigint[]],
      'view'
    >;
...
getFunction(nameOrSignature: 'isAuthorizedMinter'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'mintPlayer'): TypedContractMethod<
      [to: AddressLike, name: string, position: string, rating: BigNumberish, nationality: string, isLegendary: boolean, tokenURI: string, ],
      [bigint],
      'nonpayable'
    >;
...
getFunction(nameOrSignature: 'ownerOf'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'playerExists'): TypedContractMethod<
      [arg0: string, ],
      [boolean],
      'view'
    >;
...
getEvent(key: 'PlayerMinted'): TypedContractEvent<PlayerMintedEvent.InputTuple, PlayerMintedEvent.OutputTuple, PlayerMintedEvent.OutputObject>;
getEvent(key: 'Transfer'): TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
    ...
    filters: {
      ...
      'PlayerMinted(address,uint256,string,uint256)': TypedContractEvent<PlayerMintedEvent.InputTuple, PlayerMintedEvent.OutputTuple, PlayerMintedEvent.OutputObject>;
      PlayerMinted: TypedContractEvent<PlayerMintedEvent.InputTuple, PlayerMintedEvent.OutputTuple, PlayerMintedEvent.OutputObject>;
